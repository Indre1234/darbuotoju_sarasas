...
public class SearchActivity extends AppCompatActivity {
    ...
    private RecyclerView mRVFdarbuotojai;
    private AdapterDarbuotojai mAdapter;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pdLoading.setMessage("\tPrašome palaukti...");
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://indre1234.byethost32.com/mobile/searchconfirm.php");

                // Sąrašas; Pirmas string raktas, antras string reiksme
            ...
            try {
                ...
                User user = new User (SearchActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            //this method will be running on UI thread
            pdLoading.dismiss();
            List<Darbuotojai> data=new ArrayList<>();
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        Darbuotojai darbuotojas = new Darbuotojai(
                                json_data.getString("id"),
                                json_data.getString("vartotojas"),
                                json_data.getString("iraso_sukurimo_data"),
                                json_data.getString("vardas"),
                                json_data.getString("pavarde"),
                                json_data.getString("asmens_kodas"),
                                json_data.getString("pareigos"),
                                json_data.getString("atlyginimas"),
                                json_data.getString("v_data"),
                                json_data.getString("lytis")
                        );
                        data.add(darbuotojas);
                    }

                    // Setup and Handover data to recyclerview
                    mRVFdarbuotojai = (RecyclerView) findViewById(R.id.pareigosList);
                    mAdapter = new AdapterDarbuotojai(SearchActivity.this, data);
                    mRVFdarbuotojai.setAdapter(mAdapter);
                    mRVFdarbuotojai.setLayoutManager(new LinearLayoutManager(SearchActivity.this));
